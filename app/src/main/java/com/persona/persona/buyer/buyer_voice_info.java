...
public class buyer_voice_info extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buyer_voice_info);
        ...
        voiceName = (TextView)findViewById(R.id.buyer_voice_name);
        voiceIntroduce = (TextView)findViewById(R.id.buyer_voice_introduce);
        voiceBriefHistory = (TextView)findViewById(R.id.buyer_voice_brief_history);

        voiceName.setText(name);
        loadData();

        voiceProfileImage = (ImageView)findViewById(R.id.buyer_voice_profile_image);
...
//                Glide.with(getApplicationContext()).load(uri).transform(new CenterCrop(), new RoundedCorners(20)).into(profile_btn);
        ...
        matchingRequest = (Button)findViewById(R.id.buyer_voice_info_matching_request);
        matchingRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(buyer_voice_info.this, buyer_voice_matching.class);
