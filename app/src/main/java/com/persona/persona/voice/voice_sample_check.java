...
public class voice_sample_check extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.voice_sample_check);

        noResult = (TextView)findViewById(R.id.actor_sample_check_no_result);

        dialog = new Dialog(voice_sample_check.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.voice_sample_filter);

        recyclerView = (RecyclerView)findViewById(R.id.voice_sample_recycle);
        ...
        filter = (Button)findViewById(R.id.voice_filter);
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(fileList.size() == 0){
                    ...
                    adapter = new voice_sample_recycler(fileList, pathList);
