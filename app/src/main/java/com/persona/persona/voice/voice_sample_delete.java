...
public class voice_sample_delete extends Activity {
    ...
    private TextView noResult, title;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.voice_sample_delete);

        noResult = (TextView)findViewById(R.id.actor_sample_delete_no_result);
        title = (TextView)findViewById(R.id.voice_sample_delete_title);

        dialog = new Dialog(voice_sample_delete.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.voice_sample_filter);

        recyclerView = (RecyclerView)findViewById(R.id.voice_sample_delete_recycle);
        ...
        filter = (Button)findViewById(R.id.voice_sample_delete_filter);
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(fileList.size() == 0){
                    ...
                    adapter = new voice_delete_recycler(fileList, pathList, codeList);
